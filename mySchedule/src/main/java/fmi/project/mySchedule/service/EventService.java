...
import fmi.project.mySchedule.model.database.event.EventParticipant;
import fmi.project.mySchedule.model.database.event.EventStatus;
import fmi.project.mySchedule.model.database.event.Priority;
import fmi.project.mySchedule.model.database.user.Role;
import fmi.project.mySchedule.model.database.user.User;
import fmi.project.mySchedule.model.exception.ValidationException;
import fmi.project.mySchedule.model.request.event.EventStatusRequest;
import fmi.project.mySchedule.model.request.event.EventUpdateRequest;
...
import fmi.project.mySchedule.validator.EventValidator;
